...
logging.basicConfig(level=logging.INFO,
                    ...
                    handlers=[
                            logging.FileHandler("Logs/tass_logger.log"),
...
class tassConnector:
    ...
    def get_metadata(self, response: List, number: int) -> dict[str, Any] | Literal[False] | None | datetime.date | str:
        ...
        if current_date < datetime.datetime(2024, 12, 31):
...
class NewsParser:
    ...
    def process (self):
        ...
        """
        # start_date =  
        start_date = datetime.datetime(year=2023, month=1, day=3, hour=17, minute=22, second=29)

        if os.path.isfile("Data/tass_data.csv"):
